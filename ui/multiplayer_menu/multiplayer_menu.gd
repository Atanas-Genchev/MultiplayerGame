...
func _ready() -> void:
	...
	ip_address_text_edit.text = MultiplayerConfig.ip_addres
...
func validate():
	...
	if ip.is_valid_ip_address():
		MultiplayerConfig.ip_addres = ip
	else:
		MultiplayerConfig.ip_addres = ""
	...
	var is_valid_ip := !MultiplayerConfig.ip_addres.is_empty()
...
func _on_join_pressed() -> void:
	...
	var error := client_peer.create_client(MultiplayerConfig.ip_addres, MultiplayerConfig.port)
